...
const IDIOMAS = {
    'ca': {
        ...
        'config_reset': 'Reset',
        'config_reset_desc': 'Reiniciar el sistema',
        'reset_titulo': 'Reiniciar el Sistema',
        'reset_confirmacion': 'Estàs segur que vols reiniciar el sistema?',
        'reset_descripcion': 'El sistema es reiniciarà i es perdrà la connexió temporalment.',
        'reset_ejecutando': 'Reiniciant el sistema...',
        ...
        // Backup
        'backup': 'Backup',
        'backup_desc': 'Descargar configuraciones',
        'backup_descripcion': 'Descarga copias de seguridad de las configuraciones:',
        'backup_alarmas_desc': 'Configuración de alarmas programadas',
        'backup_telegram_desc': 'Configuración de Telegram',
        'backup_config_desc': 'Configuración general del sistema',
        'descargar': 'Descargar',
        'restaurar': 'Restaurar',
        ...
        // Backup
        'backup': 'Backup',
        'backup_desc': 'Descarregar configuracions',
        'backup_descripcion': 'Descarrega còpies de seguretat de les configuracions:',
        'backup_alarmas_desc': 'Configuració d\'alarmes programades',
        'backup_telegram_desc': 'Configuració de Telegram',
        'backup_config_desc': 'Configuració general del sistema',
        ...
        "comprobar": "Comprovar",
        "actualizar_firmware": "Firmware",
        "actualizar_spiffs": "SPIFFS",
        "actualizar_completo": "Complet",
        "ota_confirmar_firmware": "Actualitzar només el firmware? Això reiniciarà el dispositiu.",
        "ota_confirmar_spiffs": "Actualitzar només SPIFFS? Això reiniciarà el dispositiu i substituirà els fitxers.",
        "ota_confirmar_completo": "Actualització completa (firmware + SPIFFS)? Això reiniciarà el dispositiu.",
        "ota_instalando_firmware": "Instal·lant firmware...",
        "ota_instalando_spiffs": "Instal·lant SPIFFS...",
        "ota_instalando_completo": "Instal·lant actualització completa...",
    ...
    'es': {
        ...
        'config_reset_desc': 'Reiniciar el sistema',
        'reset_titulo': 'Reiniciar el Sistema',
        'reset_confirmacion': '¿Estás seguro que quieres reiniciar el sistema?',
        'reset_descripcion': 'El sistema se reiniciará y se perderá la conexión temporalmente.',
        'reset_ejecutando': 'Reiniciando el sistema...',
       ...
       "tipo_calefaccion": "🔥 Calefacción",
        ...
        "actualizar_firmware": "Firmware",
        "actualizar_spiffs": "SPIFFS",
        "actualizar_completo": "Completo",
        "ota_confirmar_firmware": "¿Actualizar solo el firmware? Esto reiniciará el dispositivo.",
        "ota_confirmar_spiffs": "¿Actualizar solo SPIFFS? Esto reiniciará el dispositivo y reemplazará los archivos.",
        "ota_confirmar_completo": "¿Actualización completa (firmware + SPIFFS)? Esto reiniciará el dispositivo.",
        "ota_instalando_firmware": "Instalando firmware...",
        "ota_instalando_spiffs": "Instalando SPIFFS...",
        "ota_instalando_completo": "Instalando actualización completa...",
